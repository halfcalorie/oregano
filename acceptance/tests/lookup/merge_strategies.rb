...
tag 'audit:medium',
  ...
  master_confdir = master.oregano('master')['confdir']
...
:backends:
  - yaml
:yaml:
  :datadir: "/etc/oreganolabs/code/environments/%{::environment}/hieradata"
:hierarchy:
  - "host"
  - "roles"
  - "profiles"
...
HIERA
    on(master, "chown oregano:oregano #{master_confdir}/hiera.yaml")
