...
describe Oregano::FileSystem::Uniquefile do
  ...
  describe "#open_tmp on Windows", :if => Oregano.features.microsoft_windows? do
    ...
    describe "with UTF8 characters" do
      ...
      it "should use UTF8 characters in TMP,TEMP,TMPDIR environment variable" do
        ...
        Oregano::Util::Windows::Process.set_environment_variable('TMPDIR', temp_rune_utf8)
        Oregano::Util::Windows::Process.set_environment_variable('TMP', temp_rune_utf8)
        Oregano::Util::Windows::Process.set_environment_variable('TEMP', temp_rune_utf8)
