...
describe "Windows UTF8 environment variables", :if => Oregano.features.microsoft_windows? do
  # The Oregano::Util::Windows::Process class is used to manipulate environment variables as it is known to handle UTF8 characters. Where as the implementation of ENV in ruby does not.
  ...
  after(:all) {
    ...
    Oregano::Util::Windows::Process.set_environment_variable(@varname, nil)
  }
