require 'spec_helper'
require 'oregano/module_tool/install_directory'

describe Oregano::ModuleTool::InstallDirectory do
  ...
  it "(#15202) creates the install directory" do
    ...
    install = Oregano::ModuleTool::InstallDirectory.new(target_dir)
  ...
  it "(#15202) errors when the directory is not accessible" do
    ...
    expect {
      ...
      Oregano::ModuleTool::Errors::PermissionDeniedCreateInstallDirectoryError
    )
  end
  ...
  it "(#15202) errors when an entry along the path is not a directory" do
    ...
    expect {
      install.prepare('module', '1.0.1')
    }.to raise_error(Oregano::ModuleTool::Errors::InstallPathExistsNotDirectoryError)
  end
