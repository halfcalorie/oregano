...
describe 'Oregano::Parser::Functions#hiera_array' do
  ...
  it 'should raise an error since this function is converted to 4x API)' do
    expect { scope.function_hiera_array(['key']) }.to raise_error(Oregano::ParseError, /can only be called using the 4.x function API/)
  end
end
