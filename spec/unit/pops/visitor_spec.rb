...
describe Oregano::Pops::Visitor do
  describe "A visitor and a visitable in a configuration with min and max args set to 0" do
    class DuckProcessor
      def initialize
        @friend_visitor = Oregano::Pops::Visitor.new(self, "friend", 0, 0)
      end
    ...
    class Duck
      include Oregano::Pops::Visitable
    end
  ...
  describe "A visitor and a visitable in a configuration with min =1, and max args set to 2" do
    class DuckProcessor2
      def initialize
        @friend_visitor = Oregano::Pops::Visitor.new(self, "friend", 1, 2)
      end
