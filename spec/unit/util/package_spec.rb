...
describe Oregano::Util::Package, " versioncmp" do

  it "should be able to be used as a module function" do
    expect(Oregano::Util::Package).to respond_to(:versioncmp)
  end
  ...
  it "should be able to sort a long set of various unordered versions" do
    ...
    newary = ary.sort { |a, b| Oregano::Util::Package.versioncmp(a,b) }
